...
/**
 * Classe utilitária com métodos para manipulação de elementos e detecção de colisões.
 */
public class Util {

	/**
	 * Verifica se dois elementos colidem no plano 2D.
	 *
	 * @param a Elemento A
	 * @param b Elemento B
	...
	/**
	 * Verifica se dois elementos colidem no eixo X.
	 *
	 * @param a Elemento A
	 * @param b Elemento B
	 * @return true se houver colisão no eixo X, false caso contrário
	 */
	 ...
	 * @param larg Largura da área de centralização
	 * @param alt  Altura da área de centralização
	 */
	...
	/**
	 * Verifica se um elemento saiu dos limites definidos pela largura e altura.
	 *
